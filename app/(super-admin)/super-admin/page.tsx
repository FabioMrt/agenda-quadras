  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        {statCards.map(({ label, value, icon: Icon, growth, accent }) => (
          <div
            key={label}
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              {growth && (
                <div className="flex items-center gap-0.5 text-arena-accent">
                  <TrendingUp size={12} />
                  <span className="text-[0.625rem] font-heading font-semibold">
                    {growth}
                  </span>
                </div>
              )}
