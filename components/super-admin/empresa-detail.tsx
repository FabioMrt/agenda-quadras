...
export function EmpresaDetailClient({ company }: { company: CompanyDetail }) {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {[
          ...
          <div key={label} className="bg-arena-surface rounded-xl p-4 border border-arena-border">
            ...
            <p className={`font-heading font-bold text-sm ${accent ? "text-arena-accent" : "text-white"}`}>{value}</p>
