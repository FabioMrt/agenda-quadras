      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        {[
          ...
          <div key={label} className="bg-arena-surface rounded-xl p-3 border border-arena-border text-center">
            ...
            <p className="text-white font-heading font-extrabold text-lg">{value}</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-4 mt-3">
                  <div>
                    <p className="text-white font-heading font-bold text-sm">{company.courtsCount}</p>
                    <p className="text-arena-text-muted text-[0.625rem]">Quadras</p>
                  </div>
                  <div className="w-px h-6 bg-arena-border" />
                  <div>
                    <p className="text-white font-heading font-bold text-sm">{company.monthlyBookings}</p>
